...
body {
    ...
    overflow: hidden; /* Prevent body overflow to manage scrolling in main content */
}
...
a.sidebar-link {
    ...
    position: relative;
    z-index: 1; /* Ensure sidebar links are clickable */
}
...
#sidebar:not(.expand) .sidebar-item .sidebar-dropdown {
    ...
    min-width: 15rem;
    display: none;
    z-index: 1; /* Ensure dropdowns are clickable */
}
